<script setup>
    ...
    const onSelect=(e,selectValue,item)=>{
      e.stopPropagation()
...
<template>
  <div class="step3-wrap">
      ...
      <ul class="game_list">
        ...
        <li class="item"  v-for="itemData in infoState.list" @click="(e)=>handleChange(e,itemData)">
              <div :style="{backgroundColor:itemData.bgColor}" class="icons-wrap">
              ...
              <ul class="status-list" v-show="currentItem === itemData.url">
                ...
                <li v-for="elData in statusMap" class="status-item" @click="(e)=>onSelect(e,elData,itemData)">
